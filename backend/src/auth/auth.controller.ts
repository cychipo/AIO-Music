...
export class AuthController {
  ...
  @ApiResponse({
    status: 201,
    description: "Trả về user + accessToken + refreshToken",
  })
  ...
  @ApiResponse({
    status: 401,
    description: "Sai email/password hoặc tài khoản OAuth",
  })
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({
    summary: "Lấy access token mới bằng refresh token (rotation)",
  })
  @ApiResponse({
    status: 200,
