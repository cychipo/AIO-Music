  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (status === 409) {
        ...
        if (provider === "google") {
          setError("Email này đã được đăng ký qua Google. Vui lòng đăng nhập bằng Google.");
        } else if (provider === "facebook") {
          setError("Email này đã được đăng ký qua Facebook. Vui lòng đăng nhập bằng Facebook.");
        } else {
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 md:p-16 bg-[#221810] overflow-y-auto relative">
        ...
        <div className="max-w-[440px] w-full">
          ...
          <div className="mb-10 text-center lg:text-left">
            ...
            <p className="text-slate-400">Experience music like never before.</p>
          </div>
